...
function FieldSet({
  ...
  return (
    <fieldset
      data-slot="field-set"
      className={cn(
        "flex flex-col gap-1 has-[>[data-slot=checkbox-group]]:gap-1.5 has-[>[data-slot=radio-group]]:gap-1",
        className
      )}
      {...props} />
  );
...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-1 font-semibold uppercase data-[variant=label]:text-xs data-[variant=legend]:text-xs",
        className
      )}
      {...props} />
  );
